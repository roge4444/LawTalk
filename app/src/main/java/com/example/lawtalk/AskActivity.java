...
public class AskActivity extends Navigation_BaseActivity{
    ...
    private static String TAG = "AskActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("LawTalk -  即時法律諮詢");
        setUpAll(toolbar);
    ...
    private void recordMessage() {
        ...
        if(listening != true) {
            ...
            listening = true;
            Toast.makeText(AskActivity.this,"Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                capture.close();
                listening = false;
                Toast.makeText(AskActivity.this,"Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void showError(final Exception e) {
        runOnUiThread(new Runnable() {
            @Override public void run() {
                Toast.makeText(AskActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
